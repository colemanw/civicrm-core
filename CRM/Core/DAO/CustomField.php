 ...
 * (GenCodeChecksum:d558965d2fd1bb39fa9a8d6dd78668c6)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'settings' => [
          'name' => 'settings',
          'type' => CRM_Utils_Type::T_TEXT,
          'title' => ts('Search Display Settings'),
          'description' => ts('Configured field settings'),
          'where' => 'civicrm_custom_field.settings',
          'default' => NULL,
          'table_name' => 'civicrm_custom_field',
          'entity' => 'CustomField',
          'bao' => 'CRM_Core_BAO_CustomField',
